          ...
          tarjeta.innerHTML = `
            <div class="resultado">
                    ...
                    <div class="informacion">
                        ...
                        <span class="canal"><img src="${video.canalImg}" alt="">Leonardo Kuffo</span>
                        <span class="descripcion">¿Qué es REST y RESTful APIs? En este video voy directo al grano y te explico en español todo lo que necesitas saber sobre REST...</span>
                    </div>
                </div>               
          `;
